  ...
  render() {
    ...
    const classesListItem =
      (collapse &&
        ...
        currentContent.content.label === label) ||
      (!collapse && typeof currentId === 'number' && currentId === this._id)
        ? cssStyles.listItemCurrent
        : cssStyles.listItem;
    ...
    return (
      <List
        ...
        classes={{
          padding: noPadding
            ? cssStyles.listItemNoPadding
            : cssStyles.listItemPadding,
        }}
      >
        <ListItem
          button
          ...
          style={{
            ...style,
            ...{
              padding: noPadding ? '12px 16px' : '8px 16px',
              width: collapse ? 56 : 171,
            },
          }}
        ...
        >
          ...
          {enableLabel && (
            <ListItemText inset primary={label} classes={classes} />
          )}
    ...
    return (
      <div>
        ...
        {contents &&
          ...
          Object.entries(contents).map((contentKey, i) => {
            ...
            if (
              (collapse && hideMenu.includes('icons')) ||
...
class Nav extends React.Component {
  render() {
    ...
    return (
      <div style={{ backgroundColor: '#67B75F' }}>
        {width === 'xs' && (
          <Drawer
            key={key}
            variant="temporary"
